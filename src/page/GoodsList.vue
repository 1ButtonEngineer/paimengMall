                  ...
                  <ul>
                    ...
                    <li v-for="item in goodsList">
                      ...
                      <div class="main">
                        ...
                        <div class="btn-area">
                          <!-- 对于javascript:和javascript:void(0)差距不大,意思大概为一个死标签，表示神魔都不执行 -->
    ...
    export default{
      data() {
          return {
            ...
            slides: [
		        {
		          src: require('../../static/slide-img/swiper01.jpg'),
		          title: '',
		          href: 'detail/analysis'
		        },
		        {
		          src: require('../../static/slide-img/swiper02.jpg'),
		          title: '',
		          href: 'detail/count'
		        },
		        {
		          src: require('../../static/slide-img/swiper03.jpg'),
		          title: '',
		          href: 'http://xxx.xxx.com'
		        },
		        {
		          src: require('../../static/slide-img/swiper04.jpg'),
		          title: '',
